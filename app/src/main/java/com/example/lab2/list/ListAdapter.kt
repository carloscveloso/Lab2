...
class ListAdapter: RecyclerView.Adapter<ListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.desc_txt).text = currentItem.descricao
        holder.itemView.findViewById<TextView>(R.id.date_txt).text = currentItem.data
